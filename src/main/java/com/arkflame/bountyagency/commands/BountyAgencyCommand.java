...
import com.arkflame.bountyagency.listeners.SignCreateListener;

public class BountyAgencyCommand implements CommandExecutor {

    BountyAgency main;

    public BountyAgencyCommand(BountyAgency main) {
        this.main = main;
    }
    ...
    private void create(String[] args) {
        main.getServer().getPluginManager().registerEvents(new SignCreateListener(main, args), main);
    }
